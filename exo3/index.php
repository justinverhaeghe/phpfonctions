...
$firstname = 'Justin';
$lastname = 'Verhaeghe';
function stringFunction($firstname, $lastname)
{
...
<head>
    ...
    <title>PHP Fonctions - Exercice 3</title>
</head>
<!-- Header -->
...
<body>
    ...
    <main>
        ...
        <div class=" text-center pt-4">
            <p>Consigne : Faire une fonction qui prend en paramètre deux chaines de caractères et qui renvoit la
                concaténation de ces deux chaines.</p>
